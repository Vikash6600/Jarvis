...
_LADDERS = {
    FAST: (LIVE, "gemini-flash-lite-latest", "gemini-flash-latest", "gemini-2.5-flash-lite"),
    SMART: (LIVE, "gemini-flash-latest", "gemini-pro-latest", "gemini-2.5-flash"),
    ...
    SEARCH: ("gemini-flash-latest", "gemini-pro-latest", "gemini-2.5-flash"),
}
